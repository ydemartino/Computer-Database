...
public class ComputerController {
	...
	private static final int NB_PER_PAGE = 10;
	...
	public String addPost(@Valid @ModelAttribute("computer") Computer computer,
			BindingResult result, Model model, HttpServletRequest request,
			RedirectAttributes redirectAttributes) {
		if (!result.hasErrors()) {
			service.saveOrUpdate(computer, request.getRemoteAddr());
			redirectAttributes
					.addFlashAttribute("computer", computer.getName());
